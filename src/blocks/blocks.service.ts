...
import { TypesService } from 'src/typess/types.service';

@Injectable()
export class BlocksService {
  constructor(@InjectModel(Block) private blockModule: typeof Block,
private readonly typeService: TypesService){}
  ...
  async update(id: number, updateBlockDto: UpdateBlockDto): Promise<Block | null> {
